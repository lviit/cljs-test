    ...
    [:div
     ...
     [:> styled-container {:blurred match-details-open}
      [:> styled-header-container
       [:> styled-header
        "Cljs football live scores"
        [:> select-competition]]
       [:> styled-bottom-container [:> styled-title (get active-competition :name)]
        [pager]]]
